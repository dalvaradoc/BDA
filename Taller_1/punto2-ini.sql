...
CREATE TABLE IF NOT EXISTS `bda_ws1`.`evaluation` (
  ...
  INDEX `fk_evaluation_semester1_idx` (`semester_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_evaluation_course1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_evaluation_semester1`
...
CREATE TABLE IF NOT EXISTS `bda_ws1`.`course_evaluated` (
  ...
  INDEX `fk_course_evaluated_time1_idx` (`time_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_course_evaluated_student1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_course_evaluated_time1`
    FOREIGN KEY (`time_id`)
    REFERENCES `bda_ws1`.`time` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
