...
/* Populate Your Dimension Table with values*/
	...
	SELECT
		...
		CONVERT(DATETIME, '31/12/' + CONVERT(VARCHAR, DATEPART(YY, @CurrentDate))) AS LastDayOfYear,
...
DECLARE
	@dtFiscalYearStart SMALLDATETIME = '01/01/1995',
	@FiscalYear INT = 1995,
	@LastYear INT = 2025,
...
(1,20230101,44347,121907,1,1,1,1,2,11,13,2),
(1,20230101,44347,121907,1,1,2,1,1,22.50,24,1.5),
(1,20230101,44347,121907,1,1,3,1,1,42,43.5,1.5),

(2,20230101,44519,122159,1,2,3,1,1,42,43.5,1.5),
(2,20230101,44519,122159,1,2,4,1,3,54,60,6),

(3,20230101,52415,143335,1,3,2,2,2,11,13,2),
(3,20230101,52415,143335,1,3,3,2,1,42,43.5,1.5),
(3,20230101,52415,143335,1,3,4,2,3,54,60,6),
(3,20230101,52415,143335,1,3,5,2,1,135,139,4),
--2-jan-2013
--SalesInvoiceNumber,SalesDateKey,SalesTimeKey,SalesTimeAltKey,StoreID,CustomerID,ProductID ,SalesPersonID,Quantity,ProductActualCost,SalesTotalCost,Deviation)
(4,20230102,44347,121907,1,1,1,1,2,11,13,2),
(4,20230102,44347,121907,1,1,2,1,1,22.50,24,1.5),

(5,20230102,44519,122159,1,2,3,1,1,42,43.5,1.5),
(5,20230102,44519,122159,1,2,4,1,3,54,60,6),

(6,20230102,52415,143335,1,3,2,2,2,11,13,2),
(6,20230102,52415,143335,1,3,5,2,1,135,139,4),

(7,20230102,44347,121907,2,1,4,3,3,54,60,6),
(7,20230102,44347,121907,2,1,5,3,1,135,139,4),

--3-jan-2013
--SalesInvoiceNumber,SalesDateKey,SalesTimeKey,SalesTimeAltKey,StoreID,CustomerID,ProductID ,SalesPersonID,Quantity,ProductActualCost,SalesTotalCost,Deviation)
(8,20230103,59326,162846,1,1,3,1,2,84,87,3),
(8,20230103,59326,162846,1,1,4,1,3,54,60,3),


(9,20230103,59349,162909,1,2,1,1,1,5.5,6.5,1),
(9,20230103,59349,162909,1,2,2,1,1,22.50,24,1.5),

(10,20230103,67390,184310,1,3,1,2,2,11,13,2),
(10,20230103,67390,184310,1,3,4,2,3,54,60,6),

(11,20230103,74877,204757,2,1,2,3,1,5.5,6.5,1),
(11,20230103,74877,204757,2,1,3,3,1,42,43.5,1.5)
Go